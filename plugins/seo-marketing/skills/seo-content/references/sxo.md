...
Read `references/sxo/page-type-taxonomy.md` for classification rules.
...
- Classify target page using `references/sxo/page-type-taxonomy.md`
...
Read `references/sxo/user-story-framework.md` for the full framework.
...
Read `references/sxo/persona-scoring.md` for methodology.
...
Read `references/sxo/wireframe-templates.md` for templates.
