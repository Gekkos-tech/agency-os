...
This is the core differentiator. Load `references/clustering/serp-overlap-methodology.md` for
the full algorithm.
...
Load `references/clustering/hub-spoke-architecture.md` for full specifications.
...
Generate `cluster-map.html` using the template at `references/clustering/templates/cluster-map.html`.
...
1. Load `references/clustering/execution-workflow.md` for the full algorithm
