...
- Filter out non-competitors (Wikipedia, Reddit, Pinterest, Amazon, YouTube, government sites, SEO tool pages, job boards, directories, news aggregators, social platforms). See `references/content-brief/excluded-domains.md` for the full list.
...
Apply the page-type template from `references/content-brief/page-type-templates.md`, then customise based on competitor gaps and search intent.
...
Read `references/content-brief/keyword-density.md` for the full rules. Summary:
