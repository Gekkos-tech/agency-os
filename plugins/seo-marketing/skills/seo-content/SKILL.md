...
- **Content briefs** (competitive, per-section word counts): [references/content-brief.md](references/content-brief.md)
- **Topic clustering** (SERP overlap, hub-and-spoke): [references/clustering.md](references/clustering.md)
- **Content planning** (industry templates): [references/planning.md](references/planning.md)
- **Programmatic SEO**: [references/programmatic.md](references/programmatic.md)
- **SXO / search experience** (page-type mismatch, persona scoring): [references/sxo.md](references/sxo.md)
