...
**Runtime context:** Load `references/flow-framework/flow-framework.md` on every `/seo flow` activation.
...
1. Read `references/flow-framework/flow-framework.md`
...
1. Read all files in `references/flow-framework/prompts/find/`
...
1. Read the file in `references/flow-framework/prompts/leverage/`
...
1. Read all file names in `references/flow-framework/prompts/optimize/`
...
### On `/seo flow win [url]`
1. Read all files in `references/flow-framework/prompts/win/`
...
1. Read all files in `references/flow-framework/prompts/local/`
...
### On `/seo flow prompts`
1. Read `references/flow-framework/prompts/README.md`
...
- `references/flow-framework/flow-framework.md` — FLOW operating model (load on every `/seo flow` activation)
- `references/flow-framework/bibliography.md` — Evidence sources; load when citing studies or statistics
- `references/flow-framework/prompts/README.md` — Prompt index; load for `/seo flow prompts`
- `references/flow-framework/prompts/find/` — 5 prompts; load for `/seo flow find`
- `references/flow-framework/prompts/leverage/` — 1 prompt; load for `/seo flow leverage`
- `references/flow-framework/prompts/optimize/` — 21 prompts; load selectively for `/seo flow optimize`
- `references/flow-framework/prompts/win/` — 3 prompts; load for `/seo flow win`
- `references/flow-framework/prompts/local/` — 11 prompts; load for `/seo flow local`
...
| Scenario | Action |
|----------|--------|
| `references/flow-framework/flow-framework.md` missing | "FLOW reference files not synced. Run: `/seo flow sync`" |
