...
Load `references/hreflang/cultural-profiles.md` for pre-built profiles (DACH, Francophone, Hispanic, Japanese).
...
Load `references/hreflang/content-parity.md` for the full parity matrix and scoring methodology.
...
Load `references/hreflang/locale-formats.md` for number, date, currency, address, and phone format
...
- `references/hreflang/cultural-profiles.md`: DACH, Francophone, Hispanic, Japanese cultural adaptation profiles
- `references/hreflang/locale-formats.md`: Number, date, currency, address, phone format tables per locale
- `references/hreflang/content-parity.md`: Content parity audit methodology and scoring
