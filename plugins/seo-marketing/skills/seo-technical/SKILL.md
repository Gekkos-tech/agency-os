...
- **XML sitemaps** (validation, generation, quality gates): [references/sitemap.md](references/sitemap.md)
- **Hreflang / international SEO**: [references/hreflang.md](references/hreflang.md)
- **Image SEO** (alt text, formats, sizes, lazy loading, WebP/AVIF): [references/images.md](references/images.md)
