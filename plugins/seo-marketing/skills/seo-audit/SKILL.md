...
## Consolidated capabilities (references)

This skill also owns these audit modes — read the matching reference before running them:

- **Full-site audit workflow** (crawl config, subagent delegation, output files, PDF report): [references/full-audit.md](references/full-audit.md)
- **Single-page audit**: [references/single-page.md](references/single-page.md)
- **Drift monitoring** (baseline / diff / regression after deployments): [references/drift-monitoring.md](references/drift-monitoring.md)
- **Unlighthouse** (free multi-page Lighthouse, no API quota): [references/unlighthouse.md](references/unlighthouse.md)
